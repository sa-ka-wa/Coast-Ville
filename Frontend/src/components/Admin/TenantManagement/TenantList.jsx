...
// FIXED: Correct path is ../../services/tenants (go up 2 levels from components/Admin/TenantManagement)
  ...
  const handleAddEdit = async (values) => {
    ...
    try {
      const tenantData = {
        ...
        move_in_date: values.moveInDate || new Date().toISOString().split('T')[0],
    ...
    <Card
      title={
        <Space>
          ...
          <span style={{ fontSize: 18, fontWeight: 600 }}>Tenant Management</span>
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              ...
              { pattern: /^0\d{9}$/, message: "Enter valid phone (e.g., 0712345678)" },
            ]}
          >
